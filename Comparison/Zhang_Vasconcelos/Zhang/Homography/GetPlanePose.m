%The function computes the pose of the plane with respect to the camera given
%the correspondences between plane and canonical image plane (the intrinsics
