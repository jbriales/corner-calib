%This function computes a 3x3 planar homography H, where pontos_ref are 
%points in the plane and pontos_img are points in the image
%
...
%pontos_img = makehomogeneous(pontos_img);
...
pontos_img      = Kpontos_img * makehomogeneous(pontos_img);
