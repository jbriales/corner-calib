classdef CKwakComp < handle
    ...
    methods
        ...
        function obj = CKwakComp (Nsim, cam_sd_N, scan_sd_N)
            ...
            obj.ConstWeighted     = cell(cam_sd_N, scan_sd_N, Nsim);
            obj.Weighted        = cell(cam_sd_N, scan_sd_N, Nsim);
        end
        
        function optim( obj, cornerOptim, Nsim_it, cam_sd_N_it, scan_sd_N_it )
            ...
            obj.NonWeighted(cam_sd_N_it, scan_sd_N_it, Nsim_it)   = {[R_k_nw  t_k_nw]};
            obj.ConstWeighted(cam_sd_N_it, scan_sd_N_it, Nsim_it) = {[R_k_cw  t_k_cw]};
            obj.Weighted(cam_sd_N_it, scan_sd_N_it, Nsim_it)      = {[R_kC_nw t_kC_nw]};
